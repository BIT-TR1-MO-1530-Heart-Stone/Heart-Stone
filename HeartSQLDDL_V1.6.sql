...
CREATE TABLE `post`  (
  ...
  `User_All visible` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `User_Friends visible` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `User_Self visible` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`ID`, `User_All visible`) USING BTREE,
...
-- Records of post
-- ----------------------------
INSERT INTO `post` VALUES (1, 1, '“西湖十景”是指浙江省杭州市著名旅游景点西湖上的十处特色风景，分别是苏堤春晓、曲苑风荷、平湖秋月、断桥残雪、柳浪闻莺、花港观鱼、雷峰夕照、双峰插云、南屏晚钟、三潭印月。西湖十景形成于南宋时期，基本围绕西湖分布，有的就位于湖上。', '3000', '/source/images/20160319/201603191618.png', '2016-03-18 21:36:28', NULL, '0', '1', '2');
INSERT INTO `post` VALUES (2, 2, '张家界景色很美，门票有点贵，火车站建得太小气了，不过森林公园太赞了，它美妙得展现了大自然的美丽，雄伟的山峰直插云霄。森林公园里环境优美，空气很清新，是真正的大自然风光。', '1', '/source/images/20160319/201603191920.png', '2016-03-20 16:24:32', NULL, '', NULL, NULL);
